  ...
  <div class="d-flex justify-content-between">
    ...
    <div>
      ...
      <?php else : ?>
        ...
        <a href="./admin/login.php" class="mx-2 text-light">Admin login</a>
      <?php endif; ?>
    </div>
  </div>
</div>
...
<nav class="main-header navbar navbar-expand navbar-light border-0 navbar-light text-sm" id='top-Nav'>
  ...
  <div class="container">
    ...
    <?php if ($_settings->userdata('id') > 0) : ?>
      ...
      <li class="nav-item">
        <a href="./?page=submit-archive" class="nav-link <?= isset($page) && $page == 'submit-archive' ? "active" : "" ?>">Submit Research</a>
      </li>
    <?php endif; ?>
    </ul>
